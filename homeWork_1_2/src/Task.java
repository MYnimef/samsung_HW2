...
public class Task {
    public static void main(String[] args) {
        ...
        //В следующих двух строках выведите, поместится ли это число в ячейке типа byte
        //и ячейке типа short ("YES"/"NO").
        //Запрещается использовать циклы и знания о том,
        //сколько именно байт/бит памяти занимают переменные типа int, byte, short.
        int num = in.nextInt();
